...
export default function Header1({ user }) {
  ...
  return (
    <header className="flex items-center gap-5 w-full px-4 py-2 min-h-[30px]">
      {/* Search Input */}
      <form
      ...
      <div className="flex items-center space-x-4 md:mr-2">
        ...
        <button
          className="hidden md:flex p-3 h-12 w-12 lg:h-14 lg:w-14 items-center justify-center 
