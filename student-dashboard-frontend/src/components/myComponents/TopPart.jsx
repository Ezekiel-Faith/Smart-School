...
const TopPart = () => {
  return (
    <section className="bg-(--color-purple) lg:pt-[9.412px] pt-1.5 lg:pb-[18.8px] pb-2.5 lg:px-[18.8px] px-2.5 rounded-3xl text-white tracking-tight space-y-3 md:flex md:items-center md:gap-3.5 lg:justify-between lg:max-w-[1072px]">
      ...
      <div className="flex flex-col justify-between px-1 text-left ">
        <span className="font-bold pr-0.5 lg:text-[15.059px] lead-[120%] lg:font-normal lg:lowercase">
          <span className="font-extrabold ml-1">3</span> Pending Assignment |{" "}
          <span className="font-extrabold ml-1">12</span> Completed Assignment
        </span>
      </div>
    </section>
  );
