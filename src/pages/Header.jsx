...
function Header() {
  ...
  return (
    ...
    <header className="flex justify-between items-center mx-30">
            ...
            <li key={link.id} className=''>
              <Link
                ...
                className={`
                  ...
                  ${activeLink === link.id 
                    ? 'text-[17px] font-[600] underline underline-offset-5 text-blue-900 decoration-blue-900 decoration-2'
                    : 'text-project links'
                  }
                `}
              >
      ...
      <button 
        className='btn mr-3 font-project p-2 rounded-[8px] w-[189px] h-[57px] px-[22px] py-[16px] cursor-pointer relative text-white register-btn transition duration-1000 ease-in-out hover:bg-gradient-to-[233deg]'
      >
        Register
      </button>
    </header>
