  ...
  return(
    <>
      ...
      <div className='font-project flex flex-col items-start'>
        ...
        <button className='apply-btn flex w-[189px] h-[57px] py-[12px] px-[24px] justify-center items-center gap-[14.938px] bg-black text-white self-center rounded-[8px] mx-10 cursor-pointer hover:bg-linear-to-tr hover:from-purple-800 hover:to-black hover:transition-all hover:duration-500 hover:ease-in-out my-20'>{StudentProperties.buttonText}</button>
      </div>
    </section>
    </>
)
