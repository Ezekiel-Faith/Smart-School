...
const Testimonials = () => {
  ...
  return (
    <div>
      <section className='relative mt-5 xl:mt-20 md:mb-21'>
        <motion.div
        ...
        >
          ...
          <div className='bg-purple-500 h-50 w-full flex flex-col justify-center items-center'>
            <h2 className='text-white text-2xl md:text-3xl font-bold text-center -mt-20 font-space-grotesk'>
              TESTIMONIALS
            </h2>
            <p className='text-white text-xl md:text-2xl text-center font-space-grotesk'>
          ...
          <div className='max-w-6xl mx-auto -mt-100 md:-mt-120 h-100'>
            ...
            <div className='custom-pagination-wrapper flex justify-center items-center mt-30'>
              ...
              >
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  className='h-4 sm:h-5 w-4 md:w-4 sm:w-5'
                  fill='none'
                  viewBox='0 0 24 24'
                  stroke='currentColor'
                >
