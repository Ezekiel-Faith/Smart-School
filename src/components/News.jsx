...
export default function DownloadNews() {
  return (
    ...
    //       <div className='border-5 relative md:flex lg:flex-row flex-col items-center faq--container md:py-30 py-10 px-5 md:px-10 mt-20 justify-between rounded-[8px] bg-black md:w-full md:m-10'>
    ...
    //           </h1>
    //           <p className='text-[18px] normal-case font-[400] font-project self-stretch text-white leading-[19.2px] w-[100%] description lg:w-[100%]'>
    ...
    //               className='email-input text-[16px] font-[600] px-4 py-2rounded-[32px] flex-[1_1_auto] min-w-0 focus:outline-none focus:ring-0 invalid:text-red-400 focus:invalid:outline-red-500 focus:invalid:border-red-400'
    //               required
    //             />
