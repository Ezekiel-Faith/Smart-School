  ...
  return(
    <>
      ...
      <div className='form-container p-30 flex flex-col items-center justify-center gap-3 md:w-auto md:m-10 md:p-20'>
        <h1 className='text-center text-white font-[600] text-[31px] normal-case leading-[37.2px] font-project '>{DownloadProperties.title}</h1>
  ...
  {DownloadProperties.buttonText}
      ...
      <div className='relative subscribe-container w-[1440px] flex flex-row items-center py-50 px-10 mt-20 justify-between md:w-auto md:m-10 '>
        <div className='subscribe-header '>
          ...
          <p className='text-[16px] normal-case font-[400] font-project self-stretch text-white leading-[19.2px] w-[70%]'>{SubscribeProperties.description}</p>
        </div>
        <div className='z-10'>
          <form className='subscribe-form z-10'>
            <input type="email" placeholder={SubscribeProperties.emailPlaceholder} className='email-input z-10' required />
