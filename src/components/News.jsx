...
export default function DownloadNews(){
  return(
    <>   
      ...
      <div className='form-container p-30 flex flex-col items-center justify-center gap-3 md:w-auto md:m-10 md:p-20'>
        <h1 className='text-center text-white font-[600] text-[31px] normal-case leading-[37.2px] font-project mb-20'>{DownloadProperties.title}</h1>
        <button className='text-center text-white font-project cursor-pointer inline-flex py-[12px] px-[24px] justify-center items-center gap-[10px] rounded-[24px] bg-gradient-to-r from-[#D30000] to-[#222]'>
  ...
  {DownloadProperties.buttonText}
      ...
      <div className='relative subscribe-container flex flex-row items-center py-40 px-20 mt-20 justify-between rounded-[8px] bg-black md:w-auto md:m-10'>
        <div className='subscribe-header mx-5'>
          <h1 className='self-stretch text-[29px] text-white normal-case font-[700] leading-[30px] font-project mb-10'>{SubscribeProperties.header}</h1>
        ...
        <div className='sub-form z-10'>
          <form className='subscribe-form flex justify-items-end items-center gap-[10px] rounded-[32px] z-10'>
            <input type="email" placeholder={SubscribeProperties.emailPlaceholder} className='email-input z-10 text-[16px] rounded-3xl font-[600] leading-[39.711px] px-3.5 ' required />
