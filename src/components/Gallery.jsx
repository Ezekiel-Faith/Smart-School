      ...
      (entries) => {
        entries.forEach((entry) => {
          ...
          if (entry.isIntersecting) {
            target.classList.remove(animationClass); // Reset
            void target.offsetWidth; // Force reflow
            target.classList.add(animationClass); // Re-trigger
          } else {
        ...
        >
          <div className="relative max-w-auto w-fit max-h-auto overflow-hidden">
            ...
            <img
              ...
              className={`mx-auto max-h-auto max-w-auto object-contain transition-transform duration-300 ${
