...
export default function AnimateOnScroll({
  ...
  return (
    // The wrapper div that applies the animations based on inView status
    <div
      ref={ref} // Ref for the Intersection Observer to track visibility
      className={`${transition} ${delay} ${
        inView ? inViewClasses : animationClasses // Apply inView or out-of-view classes
