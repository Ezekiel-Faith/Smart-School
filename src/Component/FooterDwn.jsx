      ...
      <div className='flex p-3 lg:py-6 w-full flex-col lg:flex-row justify-between items-center  m-auto'>
        ...
        */}
        ...
        >
          ...
          <div className='flex  items-start justify-center lg:justify-start lg:-ml-25'>
            {' '}
            {/* Changed justify-start to justify-center for mobile, then back for lg */}
            <a
        ...
        */}
        <motion.div
          ...
          variants={easeOutCenter}
        >
          <h1 className='text-white text-4xl lg:text-2xl lg:text-5xl pb-4 font-space-grotesk font-bold text-center lg:text-left'>
            {' '}
            {/* Added text-center for mobile, lg:text-left for desktop */}
            Our Newsletters
          </h1>
          <p className='text-gray-400 text-sm lg:text-base p-6 font-space-grotesk text-start lg:text-center lg:text-left'>
            {' '}
            {/* Added text-center for mobile, lg:text-left for desktop */}
